...
exports.run = async(client, message, args) => {
  ...
  if (!args[0]) return message.channel.send(`Küfür Filtresini Ayarlamak İçin \`u!küfür aç\` | Kapatmak İstiyorsanız \`u!küfür kapat\` Yazabilirsiniz`)
  if (args[0] !== 'aç' && args[0] !== 'kapat') return message.channel.send(`Küfür Filtresini Ayarlamak İçin \`u!küfür aç\` | Kapatmak İstiyorsanız \`u!küfür kapat\` Yazabilirsiniz`)
