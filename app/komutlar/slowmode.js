...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`Bu Komutu Kullanmak İçin **Sunucuyu Yönet** Yetkisine Sahip Olmalısın!`)
  .setColor("RED")
  ...
  .setDescription(`Lütfen Bir Sayı girin örnek : **${prefix}slowmode 5**`)
  .setColor("RED")
  .setFooter(client.user.username, client.user.avatarURL);
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ["yavaşmod","yavaş-mod","slow-mode","slowmode"],
  permLevel: 2
};
